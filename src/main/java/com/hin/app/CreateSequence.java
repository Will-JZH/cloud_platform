...
public class CreateSequence {
    public static final URI baseURI = URI.create("http://www.example.org/CompositeService.owl#");
  ...
  */
	...
	public Service createSequenceService(List services) {
...
//    	{
//    		grounding.addGrounding((AtomicGrounding) ((Service)s).getGrounding());
//    	}
  ...
  * @return
  */
    public String createLabel(List<Service> services) {
    	String label = "";
    	...
    	for(int i = 0; i < services.size(); i++) { 
    		...
    		label += s.getProfile().toString().split("#")[1];
    	}
//    	label += "]";
  ...
  * @return
  */
    public Profile createProfile(Profile profile, Process process) {
  ...
  * service has one output and one input (except first and last one).
  * 
  ...
  * @return
  */
    public CompositeProcess createSequenceProcess(CompositeProcess compositeProcess, List<Service> services) {
...
//    		compositeProcess.setResult(result);
    ...
    public void runTest(ArrayList<String> servicesName, String compositeServiceName) throws Exception {
...
//    	File f1= new File("E:/owlsDocument/zhuZhouKM.owl");
//		InputStream is = new FileInputStream(f1);
//		File f2 = new File("E:/owlsDocument/zhuZhouTestKM.owl");
//		InputStream is2 = new FileInputStream(f2);
//		Service s1 = kb.readService(is, URI.create("http://www.example.org/owls/SupplyOfGoods.owl"));
//		Service s2 = kb.readService(is2, URI.create("http://www.example.org/owls/SupplyOfGoods2.owl"));

    	List<Service> services = new ArrayList<Service>();
		for(String s : servicesName)
		{
			File f = new File("E:/owlsDocument/" + s);
			InputStream is = new FileInputStream(f);
			Service ser = kb.readService(is, URI.create("http://www.example.org/owls/" + s));
			services.add(ser);
		}
...
//    	services.add(s2);
    	...
    	System.out.println("组合服务：");
    	System.out.println(s.toString());
    	
//    	String serviceName = (ont.getService()).toString().split("#")[1];
//    	System.out.println(serviceName); 
    	// print the description of new service to standard output
    	File f= new File("E:/owlsDocument/" + compositeServiceName + ".owl");
		OutputStream os = new FileOutputStream(f);
    	ont.write(os, baseURI);
...
//    	System.out.println();  
    ...
    public static void main(String[] args) throws Exception {  
    	...
    	servicesName.add("zhuZhouKM.owl");
    	servicesName.add("zhuZhouTestKM.owl");
    	String compositeServiceName = "组合服务名";
    	test.runTest(servicesName, compositeServiceName);  
    }
}
